    ...
    function sydney_set_import_files() {
        return array(
            ...
            array(
                ...
                'local_import_file'             => PS_DIR . 'demo-content/demo-content.xml',           
                'local_import_widget_file'      => PS_DIR . 'demo-content/demo-widgets.wie',
                'local_import_customizer_file'  => PS_DIR . 'demo-content/demo-customizer.dat',           
            ),
        );
    }
} 
